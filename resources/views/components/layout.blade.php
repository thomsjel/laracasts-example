        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <x-nav-link element_type="a" href="/"  :active="request()->is('/')">Home</x-nav-link>
              <x-nav-link element_type="a" href="/about" :active="request()->is('about')">About</x-nav-link>
              <x-nav-link element_type="a" href="/contact" :active="request()->is('contact')">Contact</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            ...
            <div class="text-sm font-medium text-gray-400">noreply@laracasts.com</div>
          </div>
